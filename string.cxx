...
const char REFSTRING[10][2] = {"a", "b", "c", "d", "e", "f", "g", "h", "i", "j"};
const unsigned int REFSTRSIZE = 10;
...
void* work (void* counter)
{
  ...
  for (int j = 0; j < 1000; ++j) { 
    std::string v;
    for (int i = 0; i < (*nw)/1000; i++) {
      v += REFSTRING[i%REFSTRSIZE];
    }
  }
